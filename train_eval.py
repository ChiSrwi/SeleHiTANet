...
if __name__ == '__main__':
    ...
    disease_list = ['hf'] # name of the sample data set, you can place you own data set by following the same setting
    for disease in disease_list:
        ...
        results = []
        for k in range(5):
            accuary, precision, recall, f1, roc_auc = train_model(training_file, validation_file,
